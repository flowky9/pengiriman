...
('AR006', 'Pesawat', 'B 7461 AU', 'image_6.jpg', 'DR003');
...
INSERT INTO `pengiriman` (`no_invoive`, `description`, `satuan`, `kd_armada`, `kd_driver`, `kd_custumer`, `nm_penerima`, `uang_supir`, `total_bayar`, `status`, `packinglist`, `kd_harga`, `dp`) VALUES
...
--
ALTER TABLE `admin`
  MODIFY `kd_admin` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

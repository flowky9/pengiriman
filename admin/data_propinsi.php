...
<tr>
	...
	$query = mysql_query("select * from harga order by kd_harga asc limit $pos, $batas") or die (mysql_error());
    ...
    <tr class="data">
        ...
        <a href="?module=Ubah_Propinsi&id=<?php echo $array['kd_harga'];?>" title="Ubah"><img src="../images/pencil.gif" /></a>
        <a href="?module=Hapus&id=<?php echo $array['kd_harga'];?>&execute=propinsi" title="Hapus" onclick="return confirm ('Anda yakin ingin menghapus <?php echo $array['nm_propinsi'];?> ?');"><img src="../images/trash.gif" /></a>
        </td>
    </tr>
    <?php } ?>

...
<tr>
	...
	$query = mysql_query("select armada.*,driver.nm_lengkap from armada,driver where armada.kd_driver = driver.kd_driver order by kd_armada desc limit $pos, $batas") or die (mysql_error());
    ...
    <tr class="data">
        ...
        <td><?php echo $array['kd_armada'];?></td>
        ...
        <a href="?module=Ubah_Armada&id=<?php echo $array['kd_armada'];?>" title="Ubah"><img src="../images/pencil.gif" /></a>
        <a href="?module=Hapus&id=<?php echo $array['kd_armada'];?>&execute=armada" title="Hapus" onclick="return confirm ('Anda yakin ingin menghapus <?php echo $array['nm_armada'];?> ?');"><img src="../images/trash.gif" /></a>
        </td>
    </tr>
    <?php } ?>
